...
\begin{content}
    ...
    \begin{position}{Asistente de Investigación, Data Manager}{Feb 2026 -- Presente}{Universidad de Copenhague, Dinamarca}{Prof.~Asger Wingender}{}
        \item Contribuyo al proyecto de investigación {\href{https://www.carlsbergfondet.dk/en/what-we-have-funded/cf25-1677/}{Cataloguing Crop Traits and Breeders Across the OECD 1980-2025}}, financiado por la Carlsberg Foundation.
        \item Gestiono la creación de un repositorio de datos unificado de variedades de cereales y sus características creados en la OCDE desde 1980 hasta 2025.
        \item El repositorio será el primer conjunto de datos unificado de este tipo, y será fundamental para el estudio de la mejora de la innovación en el campo de los cereales.
    \end{position}
