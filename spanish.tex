...
\begin{content}
    ...
    \begin{position}{Asistente de Investigación, Data Manager}{Feb 2026 -- Presente}{Universidad de Copenhague, Dinamarca}{Prof.~Asger Wingender}{}
        ...
        \item El repositorio será el primer conjunto de datos unificado de este tipo, y será fundamental para el estuio de la mejora de la innovación en el campo de los cereales.
    \end{position}
